           ...
           <div className='footer-top'>
            <div className='footer-brand-container'>
              ...
              <div className='social-icons'>
                ...
                <FontAwesomeIcon className="fa-brands fa-x-twitter social-icon" icon={faXTwitter} alt='Social Icon' />
                <FontAwesomeIcon className="fa-brands fa-facebook social-icon" icon={faFacebookF} alt='Social Icon' />
                <FontAwesomeIcon className="fa-brands fa-youtube social-icon" icon={faYoutube} alt='Social Icon' />
