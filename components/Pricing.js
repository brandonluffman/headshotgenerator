        ...
        <div className='pricing-grid-toggle-container'>
            ...
            <div className='div-content'>
                ...
                <div className='pricing-grid'>
                    <div className='pricing-grid-item'>
                        ...
                        <p className='pricing-grid-p'><MdVerified className='pricing-grid-icon' />20 high-quality headshots</p>
                        <p className='pricing-grid-p'><MdVerified className='pricing-grid-icon' />10+ different styles</p>
                        <p className='pricing-grid-p'><MdVerified className='pricing-grid-icon' />60 minute turnaround time</p>
                        </div>
                    ...
                    <div className='pricing-grid-item'>
                        ...
                        <div className='pricing-grid-p-container'>
                            <div className='anti-flexer'>
                        <p className='pricing-grid-p'><MdVerified className='pricing-grid-icon' />40 high-quality headshots</p>
                        <p className='pricing-grid-p'><MdVerified className='pricing-grid-icon' />20+ different styles</p>
                        <p className='pricing-grid-p'><MdVerified className='pricing-grid-icon' />45 minute turnaround time</p>
                        </div>
                        </div>                        <hr className='pricing-grid-hr'></hr>
                    ...
                    <div className='pricing-grid-item'>
                        ...
                        <div className='pricing-grid-p-container'>
                            <div className='anti-flexer'>
                        <p className='pricing-grid-p'><MdVerified className='pricing-grid-icon' />100 high-quality headshots</p>
                        <p className='pricing-grid-p'><MdVerified className='pricing-grid-icon' />75+ different styles</p>
                        <p className='pricing-grid-p'><MdVerified className='pricing-grid-icon' />30 minute turnaround time</p>
                        </div>
                        </div>
            ...
            <div className='pricing-grid team-grid'>
                    ...
                    <h3 className='pricing-grid-header true-cost-header'>${trueCost}</h3>
                        ...
                        <div className='pricing-grid-p-container'>
                            <div className='anti-flexer'>
                        <p className='pricing-grid-p'><MdVerified className='team-icon' />100 high-quality headshots</p>
