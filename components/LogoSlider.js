...
const LogoSlider = () => {
    ...
    return (
        ...
        <h2 className='logo-slider-header'><img src='/brand-logo.png' className='logo-slider-header-img'></img><span className='blue-color-change logo-slider-header-span'>HeadshotGeneratorAI</span>users hired by</h2>
