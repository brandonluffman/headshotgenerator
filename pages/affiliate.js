  ...
  return (
    <>
        ...
        <div className='affiliate-container'>
            ...
            <a href='#about'><button className='affiliate-btn btn btn-black'>Learn More</button></a>
            </div>
            <img src='/affiliate-banner.svg' className='affiliate-banner'></img>
            <h3 className='affiliate-intro' id='about'>We are HeadshotGenerator<span className='blue-color-change'>AI</span> — the leading provider of professional, field-tested templates that follow the exact “resume rules” employers look for. Our resume builder is easy to use and documents can be completed in minutes!</h3>
